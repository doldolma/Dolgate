...
export async function connectSftp(
  options: ConnectOptions,
  asyncOpts_?: { signal: AbortSignal },
): Promise<SftpConnectionInterface> /*throws*/ {
  const __stack = uniffiIsDebug ? new Error().stack : undefined;
  try {
    return await uniffiRustCallAsync(
      /*rustCaller:*/ uniffiCaller,
      /*rustFutureFunc:*/ () => {
        return nativeModule().ubrn_uniffi_uniffi_russh_fn_func_connect_sftp(
          FfiConverterTypeConnectOptions.lower(options),
        );
      },
      /*pollFunc:*/ nativeModule()
      ...
      /*freeFunc:*/ nativeModule()
        .ubrn_ffi_uniffi_russh_rust_future_free_pointer,
      /*liftFunc:*/ FfiConverterTypeSftpConnection.lift.bind(
...
export async function deriveArgon2idKey(
  ...
  salt: ArrayBuffer,
  memoryKib: /*u32*/ number,
  timeCost: /*u32*/ number,
  parallelism: /*u32*/ number,
  outputLength: /*u32*/ number,
  asyncOpts_?: { signal: AbortSignal },
  ...
  try {
    return await uniffiRustCallAsync(
      /*rustCaller:*/ uniffiCaller,
      /*rustFutureFunc:*/ () => {
        return nativeModule().ubrn_uniffi_uniffi_russh_fn_func_derive_argon2id_key(
          FfiConverterArrayBuffer.lower(passphrase),
          FfiConverterArrayBuffer.lower(salt),
          FfiConverterUInt32.lower(memoryKib),
          FfiConverterUInt32.lower(timeCost),
          FfiConverterUInt32.lower(parallelism),
          FfiConverterUInt32.lower(outputLength),
        );
      },
      /*pollFunc:*/ nativeModule()
      ...
      /*liftString:*/ FfiConverterString.lift,
      /*asyncOpts:*/ asyncOpts_,
      /*errorHandler:*/ FfiConverterTypeVaultKdfError.lift.bind(
...
export const SftpConnectionInfo = (() => {
  const defaults = () => ({});
  const create = (() => {
    return uniffiCreateRecord<SftpConnectionInfo, ReturnType<typeof defaults>>(
      defaults,
    );
  })();
  return Object.freeze({
     ...
     * Defaults specified in the {@link uniffi_russh} crate.
     */
    defaults: () => Object.freeze(defaults()) as Partial<SftpConnectionInfo>,
  });
})();

const FfiConverterTypeSftpConnectionInfo = (() => {
  type TypeName = SftpConnectionInfo;
  class FFIConverter extends AbstractFfiConverterByteArray<TypeName> {
    read(from: RustBuffer): TypeName {
      return {
...
export const SftpListing = (() => {
  const defaults = () => ({});
  const create = (() => {
    return uniffiCreateRecord<SftpListing, ReturnType<typeof defaults>>(
      defaults,
    );
  })();
  return Object.freeze({
     ...
     * Defaults specified in the {@link uniffi_russh} crate.
     */
    defaults: () => Object.freeze(defaults()) as Partial<SftpListing>,
  });
})();

const FfiConverterTypeSftpListing = (() => {
  type TypeName = SftpListing;
  class FFIConverter extends AbstractFfiConverterByteArray<TypeName> {
    read(from: RustBuffer): TypeName {
      return {
        path: FfiConverterString.read(from),
...
export const SftpReadChunk = (() => {
  const defaults = () => ({});
  const create = (() => {
    return uniffiCreateRecord<SftpReadChunk, ReturnType<typeof defaults>>(
      defaults,
    );
  })();
  return Object.freeze({
     ...
     * Defaults specified in the {@link uniffi_russh} crate.
     */
    defaults: () => Object.freeze(defaults()) as Partial<SftpReadChunk>,
  });
})();

const FfiConverterTypeSftpReadChunk = (() => {
  type TypeName = SftpReadChunk;
  class FFIConverter extends AbstractFfiConverterByteArray<TypeName> {
    read(from: RustBuffer): TypeName {
      return {
...
// Enum: VaultKdfError
export enum VaultKdfError_Tags {
...
export const VaultKdfError = (() => {
  ...
  class InvalidParams_ extends UniffiError implements InvalidParams__interface {
    /**
     * @private
     * This field is private and should not be used, use `tag` instead.
     */
    ...
    static new(v0: string): InvalidParams_ {
    ...
    static hasInner(obj: any): obj is InvalidParams_ {
      return InvalidParams_.instanceOf(obj);
    }

    static getInner(obj: InvalidParams_): Readonly<[string]> {
      return obj.inner;
    }
  }

  type Derive__interface = {
    tag: VaultKdfError_Tags.Derive;
    inner: Readonly<[string]>;
  };

  class Derive_ extends UniffiError implements Derive__interface {
    /**
     * @private
     * This field is private and should not be used, use `tag` instead.
     */
    ...
    static new(v0: string): Derive_ {
      return new Derive_(v0);
    }

    static instanceOf(obj: any): obj is Derive_ {
      return obj.tag === VaultKdfError_Tags.Derive;
    }

    static hasInner(obj: any): obj is Derive_ {
      return Derive_.instanceOf(obj);
    }

    static getInner(obj: Derive_): Readonly<[string]> {
      return obj.inner;
    }
  }

  function instanceOf(obj: any): obj is VaultKdfError {
...
export type VaultKdfError = InstanceType<
  (typeof VaultKdfError)[keyof Omit<typeof VaultKdfError, 'instanceOf'>]
>;

// FfiConverter for enum VaultKdfError
const FfiConverterTypeVaultKdfError = (() => {
  const ordinalConverter = FfiConverterInt32;
  type TypeName = VaultKdfError;
  class FFIConverter extends AbstractFfiConverterByteArray<TypeName> {
    read(from: RustBuffer): TypeName {
      switch (ordinalConverter.read(from)) {
        case 1:
...
export class SftpConnection
  extends UniffiAbstractObject
  implements SftpConnectionInterface
{
  ...
  public async chmod(
    ...
    try {
      return await uniffiRustCallAsync(
        /*rustCaller:*/ uniffiCaller,
        /*rustFutureFunc:*/ () => {
          return nativeModule().ubrn_uniffi_uniffi_russh_fn_method_sftpconnection_chmod(
            uniffiTypeSftpConnectionObjectFactory.clonePointer(this),
            FfiConverterString.lower(path),
            FfiConverterUInt32.lower(permissions),
          );
        },
        /*pollFunc:*/ nativeModule()
  ...
  public async close(asyncOpts_?: {
    ...
    try {
      return await uniffiRustCallAsync(
        /*rustCaller:*/ uniffiCaller,
        /*rustFutureFunc:*/ () => {
          return nativeModule().ubrn_uniffi_uniffi_russh_fn_method_sftpconnection_close(
            uniffiTypeSftpConnectionObjectFactory.clonePointer(this),
          );
        },
        /*pollFunc:*/ nativeModule()
  ...
  public async delete_(
    ...
    try {
      return await uniffiRustCallAsync(
        /*rustCaller:*/ uniffiCaller,
        /*rustFutureFunc:*/ () => {
          return nativeModule().ubrn_uniffi_uniffi_russh_fn_method_sftpconnection_delete(
            uniffiTypeSftpConnectionObjectFactory.clonePointer(this),
            FfiConverterString.lower(path),
          );
        },
  ...
  public getInfo(): SftpConnectionInfo {
    return FfiConverterTypeSftpConnectionInfo.lift(
      uniffiCaller.rustCall(
        /*caller:*/ (callStatus) => {
          return nativeModule().ubrn_uniffi_uniffi_russh_fn_method_sftpconnection_get_info(
            uniffiTypeSftpConnectionObjectFactory.clonePointer(this),
            callStatus,
          );
        },
  ...
  public async listDirectory(
    path: string,
    asyncOpts_?: { signal: AbortSignal },
  ): Promise<SftpListing> /*throws*/ {
    const __stack = uniffiIsDebug ? new Error().stack : undefined;
    try {
      return await uniffiRustCallAsync(
        /*rustCaller:*/ uniffiCaller,
        /*rustFutureFunc:*/ () => {
          return nativeModule().ubrn_uniffi_uniffi_russh_fn_method_sftpconnection_list_directory(
            uniffiTypeSftpConnectionObjectFactory.clonePointer(this),
            FfiConverterString.lower(path),
          );
        },
        ...
        /*freeFunc:*/ nativeModule()
          .ubrn_ffi_uniffi_russh_rust_future_free_rust_buffer,
        /*liftFunc:*/ FfiConverterTypeSftpListing.lift.bind(
  ...
  public async mkdir(
    ...
    try {
      return await uniffiRustCallAsync(
        /*rustCaller:*/ uniffiCaller,
        /*rustFutureFunc:*/ () => {
          return nativeModule().ubrn_uniffi_uniffi_russh_fn_method_sftpconnection_mkdir(
            uniffiTypeSftpConnectionObjectFactory.clonePointer(this),
            FfiConverterString.lower(path),
          );
        },
  ...
  public async readFileChunk(
    ...
    length: /*u32*/ number,
    asyncOpts_?: { signal: AbortSignal },
  ): Promise<SftpReadChunk> /*throws*/ {
    const __stack = uniffiIsDebug ? new Error().stack : undefined;
    try {
      return await uniffiRustCallAsync(
        /*rustCaller:*/ uniffiCaller,
        /*rustFutureFunc:*/ () => {
          return nativeModule().ubrn_uniffi_uniffi_russh_fn_method_sftpconnection_read_file_chunk(
            uniffiTypeSftpConnectionObjectFactory.clonePointer(this),
            FfiConverterString.lower(path),
            FfiConverterFloat64.lower(offset),
        ...
        /*freeFunc:*/ nativeModule()
          .ubrn_ffi_uniffi_russh_rust_future_free_rust_buffer,
        /*liftFunc:*/ FfiConverterTypeSftpReadChunk.lift.bind(
  ...
  public async rename(
    ...
    try {
      return await uniffiRustCallAsync(
        /*rustCaller:*/ uniffiCaller,
        /*rustFutureFunc:*/ () => {
          return nativeModule().ubrn_uniffi_uniffi_russh_fn_method_sftpconnection_rename(
            uniffiTypeSftpConnectionObjectFactory.clonePointer(this),
  ...
  public async writeFileChunk(
    ...
    try {
      return await uniffiRustCallAsync(
        /*rustCaller:*/ uniffiCaller,
        /*rustFutureFunc:*/ () => {
          return nativeModule().ubrn_uniffi_uniffi_russh_fn_method_sftpconnection_write_file_chunk(
            uniffiTypeSftpConnectionObjectFactory.clonePointer(this),
            FfiConverterString.lower(path),
            FfiConverterFloat64.lower(offset),
...
const uniffiTypeSftpConnectionObjectFactory: UniffiObjectFactory<SftpConnectionInterface> =
  (() => {
    return {
      create(pointer: UnsafeMutableRawPointer): SftpConnectionInterface {
      ...
      bless(p: UnsafeMutableRawPointer): UniffiRustArcPtr {
        return uniffiCaller.rustCall(
          /*caller:*/ (status) =>
            nativeModule().ubrn_uniffi_internal_fn_method_sftpconnection_ffi__bless_pointer(
              p,
              status,
            ),
          /*liftString:*/ FfiConverterString.lift,
      ...
      pointer(obj: SftpConnectionInterface): UnsafeMutableRawPointer {
        if ((obj as any)[destructorGuardSymbol] === undefined) {
          throw new UniffiInternalError.UnexpectedNullPointer();
        }
        return (obj as any)[pointerLiteralSymbol];
      ...
      clonePointer(obj: SftpConnectionInterface): UnsafeMutableRawPointer {
        const pointer = this.pointer(obj);
        return uniffiCaller.rustCall(
          /*caller:*/ (callStatus) =>
            nativeModule().ubrn_uniffi_uniffi_russh_fn_clone_sftpconnection(
              pointer,
              callStatus,
            ),
          /*liftString:*/ FfiConverterString.lift,
      ...
      freePointer(pointer: UnsafeMutableRawPointer): void {
        uniffiCaller.rustCall(
          /*caller:*/ (callStatus) =>
            nativeModule().ubrn_uniffi_uniffi_russh_fn_free_sftpconnection(
              pointer,
              callStatus,
            ),
          /*liftString:*/ FfiConverterString.lift,
      ...
      isConcreteType(obj: any): obj is SftpConnectionInterface {
        return (
          obj[destructorGuardSymbol] &&
...
const FfiConverterTypeSftpConnection = new FfiConverterObject(
  uniffiTypeSftpConnectionObjectFactory,
);
...
const FfiConverterArrayTypeSftpEntry = new FfiConverterArray(
...
function uniffiEnsureInitialized() {
  ...
  if (
    nativeModule().ubrn_uniffi_uniffi_russh_checksum_func_connect_sftp() !==
    30498
  ) {
    throw new UniffiInternalError.ApiChecksumMismatch(
      'uniffi_uniffi_russh_checksum_func_connect_sftp',
    );
  }
  if (
    nativeModule().ubrn_uniffi_uniffi_russh_checksum_func_derive_argon2id_key() !==
    24310
  ) {
    throw new UniffiInternalError.ApiChecksumMismatch(
      'uniffi_uniffi_russh_checksum_func_derive_argon2id_key',
    );
  }
  if (
  ...
  if (
    nativeModule().ubrn_uniffi_uniffi_russh_checksum_method_sftpconnection_chmod() !==
    45975
  ) {
    throw new UniffiInternalError.ApiChecksumMismatch(
      'uniffi_uniffi_russh_checksum_method_sftpconnection_chmod',
    );
  }
  if (
    nativeModule().ubrn_uniffi_uniffi_russh_checksum_method_sftpconnection_close() !==
    57015
  ) {
    throw new UniffiInternalError.ApiChecksumMismatch(
      'uniffi_uniffi_russh_checksum_method_sftpconnection_close',
    );
  }
  if (
    nativeModule().ubrn_uniffi_uniffi_russh_checksum_method_sftpconnection_delete() !==
    26409
  ) {
    throw new UniffiInternalError.ApiChecksumMismatch(
      'uniffi_uniffi_russh_checksum_method_sftpconnection_delete',
    );
  }
  if (
    nativeModule().ubrn_uniffi_uniffi_russh_checksum_method_sftpconnection_get_info() !==
    60189
  ) {
    throw new UniffiInternalError.ApiChecksumMismatch(
      'uniffi_uniffi_russh_checksum_method_sftpconnection_get_info',
    );
  }
  if (
    nativeModule().ubrn_uniffi_uniffi_russh_checksum_method_sftpconnection_list_directory() !==
    11891
  ) {
    throw new UniffiInternalError.ApiChecksumMismatch(
      'uniffi_uniffi_russh_checksum_method_sftpconnection_list_directory',
    );
  }
  if (
    nativeModule().ubrn_uniffi_uniffi_russh_checksum_method_sftpconnection_mkdir() !==
    52174
  ) {
    throw new UniffiInternalError.ApiChecksumMismatch(
      'uniffi_uniffi_russh_checksum_method_sftpconnection_mkdir',
    );
  }
  if (
    nativeModule().ubrn_uniffi_uniffi_russh_checksum_method_sftpconnection_read_file_chunk() !==
    7952
  ) {
    throw new UniffiInternalError.ApiChecksumMismatch(
      'uniffi_uniffi_russh_checksum_method_sftpconnection_read_file_chunk',
    );
  }
  if (
    nativeModule().ubrn_uniffi_uniffi_russh_checksum_method_sftpconnection_rename() !==
    30893
  ) {
    throw new UniffiInternalError.ApiChecksumMismatch(
      'uniffi_uniffi_russh_checksum_method_sftpconnection_rename',
    );
  }
  if (
    nativeModule().ubrn_uniffi_uniffi_russh_checksum_method_sftpconnection_write_file_chunk() !==
    25815
  ) {
    throw new UniffiInternalError.ApiChecksumMismatch(
      'uniffi_uniffi_russh_checksum_method_sftpconnection_write_file_chunk',
    );
  }
  if (

...
interface NativeModuleInterface {
  ...
  ubrn_uniffi_uniffi_russh_fn_clone_sftpconnection(
    ptr: bigint,
    uniffi_out_err: UniffiRustCallStatus,
  ): bigint;
  ubrn_uniffi_uniffi_russh_fn_free_sftpconnection(
    ptr: bigint,
    uniffi_out_err: UniffiRustCallStatus,
  ): void;
  ubrn_uniffi_uniffi_russh_fn_method_sftpconnection_chmod(
    ptr: bigint,
    path: Uint8Array,
    permissions: number,
  ): bigint;
  ubrn_uniffi_uniffi_russh_fn_method_sftpconnection_close(ptr: bigint): bigint;
  ubrn_uniffi_uniffi_russh_fn_method_sftpconnection_delete(
    ptr: bigint,
    path: Uint8Array,
  ): bigint;
  ubrn_uniffi_uniffi_russh_fn_method_sftpconnection_get_info(
    ptr: bigint,
    uniffi_out_err: UniffiRustCallStatus,
  ): Uint8Array;
  ubrn_uniffi_uniffi_russh_fn_method_sftpconnection_list_directory(
    ptr: bigint,
    path: Uint8Array,
  ): bigint;
  ubrn_uniffi_uniffi_russh_fn_method_sftpconnection_mkdir(
    ptr: bigint,
    path: Uint8Array,
  ): bigint;
  ubrn_uniffi_uniffi_russh_fn_method_sftpconnection_read_file_chunk(
    ptr: bigint,
    path: Uint8Array,
    offset: number,
    length: number,
  ): bigint;
  ubrn_uniffi_uniffi_russh_fn_method_sftpconnection_rename(
    ptr: bigint,
    sourcePath: Uint8Array,
    targetPath: Uint8Array,
  ): bigint;
  ubrn_uniffi_uniffi_russh_fn_method_sftpconnection_write_file_chunk(
    ptr: bigint,
    path: Uint8Array,
    offset: number,
    data: Uint8Array,
  ...
  ubrn_uniffi_internal_fn_method_sftpconnection_ffi__bless_pointer(
    pointer: bigint,
    uniffi_out_err: UniffiRustCallStatus,
  ): UniffiRustArcPtr;

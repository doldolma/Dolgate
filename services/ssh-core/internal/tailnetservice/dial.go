...
func (runtime *Service) Dial(route TailnetRoute) (sshconn.DialFunc, error) {
...
// tailnetDial preserves the package-local test vocabulary while production
// consumers use Dial as the service boundary.
func (runtime *Service) tailnetDial(route TailnetRoute) (sshconn.DialFunc, error) {

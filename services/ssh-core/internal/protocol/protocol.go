...
const (
	...
	CommandTailnetTest                 = coretypes.CommandTailnetTest
	CommandTailnetForget               = coretypes.CommandTailnetForget
	CommandTailnetDisconnect           = coretypes.CommandTailnetDisconnect
	...
	CommandGeneratePrivateKey          = coretypes.CommandGeneratePrivateKey
	CommandInspectPrivateKey           = coretypes.CommandInspectPrivateKey
	CommandInstallAuthorizedKey        = coretypes.CommandInstallAuthorizedKey
	...
	CommandSFTPChown                   = coretypes.CommandSFTPChown
	CommandSFTPListPrincipals          = coretypes.CommandSFTPListPrincipals
	CommandSFTPDelete                  = coretypes.CommandSFTPDelete
	CommandSFTPReadFile                = coretypes.CommandSFTPReadFile
	CommandSFTPWriteFile               = coretypes.CommandSFTPWriteFile
	...
	CommandTerminalAutocompletePrepare = coretypes.CommandTerminalAutocompletePrepare
...
const (
	...
	EventPrivateKeyGenerated            = coretypes.EventPrivateKeyGenerated
	...
	EventSFTPFileRead                   = coretypes.EventSFTPFileRead
	EventSFTPAck                        = coretypes.EventSFTPAck
	EventSFTPError                      = coretypes.EventSFTPError
	EventSFTPSudoStatus                 = coretypes.EventSFTPSudoStatus
	EventSFTPPrincipalsListed           = coretypes.EventSFTPPrincipalsListed
	...
	EventTerminalAutocompleteCapability = coretypes.EventTerminalAutocompleteCapability
...
type TailnetConfigPayload = coretypes.TailnetConfigPayload
...
type TailnetSnapshotPayload = coretypes.TailnetSnapshotPayload
...
type PrivateKeyGeneratePayload = coretypes.PrivateKeyGeneratePayload
type PrivateKeyGeneratedPayload = coretypes.PrivateKeyGeneratedPayload
type PrivateKeyInspectPayload = coretypes.PrivateKeyInspectPayload
type PrivateKeyInspectedPayload = coretypes.PrivateKeyInspectedPayload
type AuthorizedKeyInstallPayload = coretypes.AuthorizedKeyInstallPayload
type AuthorizedKeyInstalledPayload = coretypes.AuthorizedKeyInstalledPayload
...
type SFTPChownPayload = coretypes.SFTPChownPayload
type SFTPListPrincipalsPayload = coretypes.SFTPListPrincipalsPayload
type SFTPDeletePayload = coretypes.SFTPDeletePayload
type SFTPReadFilePayload = coretypes.SFTPReadFilePayload
type SFTPWriteFilePayload = coretypes.SFTPWriteFilePayload
...
type SFTPFileReadPayload = coretypes.SFTPFileReadPayload
type SFTPPrincipal = coretypes.SFTPPrincipal
type SFTPPrincipalsListedPayload = coretypes.SFTPPrincipalsListedPayload
type SFTPSudoStatusPayload = coretypes.SFTPSudoStatusPayload

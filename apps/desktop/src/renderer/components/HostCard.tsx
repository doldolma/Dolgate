  ...
  return (
    ...
    >
      <div
        ...
        className={cn(
          'inline-grid h-[2.3rem] w-[2.3rem] shrink-0 place-items-center rounded-[13px] bg-[color-mix(in_srgb,var(--accent-strong)_68%,var(--chrome-bg)_32%)] text-[0.9rem] font-bold text-white',
      ...
      <div className="min-w-0">
        <strong className="mb-[0.08rem] block max-w-full overflow-hidden text-ellipsis whitespace-nowrap text-[0.9rem] text-[var(--text)]">
          {title}
        </strong>
        <span className="block max-w-full overflow-hidden text-ellipsis whitespace-nowrap text-[0.76rem] text-[var(--text-soft)]">
          {subtitle}
        </span>
        <small className="mt-[0.02rem] block max-w-full overflow-hidden text-ellipsis whitespace-nowrap text-[0.68rem] text-[var(--text-soft)]">
          {groupLabel}
        </small>
        {hint ? (
          <small className="mt-[0.02rem] block max-w-full overflow-hidden text-ellipsis whitespace-nowrap text-[0.68rem] text-[var(--text-soft)]">
      ...
      {footer ? (
        <div className="col-span-full mt-[0.1rem] flex w-full flex-wrap items-center gap-[0.36rem] pl-[3.75rem]">
          {footer}
        </div>
      ) : null}
      {children}

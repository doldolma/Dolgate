...
file, in units of kilobytes (1024 bytes).  By default 64\xA0KB of
...
buffers for pipes, so that only 64\xA0KB (or the amount of space
...
standards/standards/ecma-48)`},{name:"--wheel-lines",args:{name:"n"},description:"Set the number of lines to scroll when the mouse wheel is rolled"}]},t=e;export{t as default};

...
export function TabButton({
  ...
  return (
    <button
      type={type}
      className={cn(
        'inline-flex items-center whitespace-nowrap rounded-full border px-[0.9rem] py-[0.55rem] text-[0.9rem] font-semibold tracking-[-0.01em] transition-[background-color,border-color,color,box-shadow] duration-150',
        active

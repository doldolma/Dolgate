  ...
  return (
    <div ref={rootRef} className={cn('relative', className)}>
      <button
        ...
        className="flex w-full min-h-11 items-center gap-2 rounded-[16px] border border-[var(--border)] bg-[var(--surface-strong)] px-4 py-[0.9rem] text-left text-[var(--text)] transition-[border-color,box-shadow,background-color] duration-150 focus:border-[var(--selection-border)] focus:outline-none focus:ring-4 focus:ring-[color-mix(in_srgb,var(--accent-strong)_10%,transparent)]"
      >
      ...
      {isOpen ? (
        <div
          ...
          className="absolute left-0 right-0 top-[calc(100%+0.4rem)] z-30 max-h-[16rem] overflow-y-auto overscroll-contain rounded-[16px] border border-[var(--border)] bg-[var(--surface-elevated)] py-1 shadow-[var(--shadow-soft)] focus:outline-none"
        >
          {options.map((option, index) => {
            ...
            return (
              <button
                ...
                className={cn(
                  'flex w-full items-center gap-2.5 px-3 py-2 text-left text-[0.92rem] text-[var(--text)]',
                  isActive
              ...
              >
                ...
                <span
                  className="shrink-0 text-[0.78rem] text-[var(--text-soft)]"
